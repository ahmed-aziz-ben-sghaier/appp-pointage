            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.presence') }}" class="nav-link">Presence</a></li>
                        <li class="nav-item"><a href="{{ route('admin.absence.requests') }}" class="nav-link">Absence Requests</a></li>
